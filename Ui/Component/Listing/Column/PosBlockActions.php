...
namespace MarekViger\PointOfSale\Ui\Component\Listing\Column;
 ...
 */
class PosBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'Pos';

    /**
     * Url paths.
     */
    private const EDIT_URL_PATH = 'pos/pos/edit';
    private const DELETE_URL_PATH = 'pos/pos/delete';
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[PosInterface::POS_ID])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData = [PosInterface::POS_ID => $item[PosInterface::POS_ID]];
